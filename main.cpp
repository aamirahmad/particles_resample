...
//             for(int k=0; k<N; k++)
//             {
//                 if(selector<cumulative_weight[k])
//                 {
//                     selectedParticleIndex = k;
//                     k=N+1;
//                     cout << endl << "Selected particle weight = " << weights[selectedParticleIndex] <<endl;
//                 }           
//             }
            int k = 0;
            while(selector>cumulative_weight[k])
            {
                k++;
            }
            selectedParticleIndex = k;
        ...
        gp << "plot '-' with vectors title 'particles', '-' with vectors title 'resampled particles' lc 4\n";
        gp.send1d(particles);
